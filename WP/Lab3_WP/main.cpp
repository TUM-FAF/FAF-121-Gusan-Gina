...
char szClassName[ ] = "Laboratory Work Nr.3";
HINSTANCE hInstance;
...
LRESULT CALLBACK WindowProcedure(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    RECT rectRED     = {35, 335, 178, 350};
    RECT rectGREEN   = {35, 355, 178, 370};
    RECT rectBLUE    = {35, 375, 178, 390};
    RECT rectTemp;
    ...
    HBRUSH hBrush;
    int xFillPreview =40 ;
    int yFillPreview = 270;
    int xStrokePreview = 110;
    int yStrokePreview = 270;
    UINT fillRED      = 255;
    UINT fillGREEN    = 255;
    UINT fillBLUE     = 255;
    UINT strokeRED    = 0;
    ...
    hbmpimage = (HBITMAP)LoadImage(hInstance, "image.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
